...
TEST_COMMAND?=$(VENV_FOLDER)/bin/pytest src/yafowil/widget/datetime/tests
...
# Default: locale
GETTEXT_LOCALES_PATH?=src/yafowil/widget/datetime/locales

# Translation domain to use.
# No default value.
GETTEXT_DOMAIN?=yafowil.widget.datetime
